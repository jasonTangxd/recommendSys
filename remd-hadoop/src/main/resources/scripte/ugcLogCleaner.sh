...
while [ $i -gt $j ]; do
    ...
    echo "hadoop jar /work/recommender/remd-hadoop-1.0-SNAPSHOT-jar-with-dependencies.jar cn.xiaoxiaomo.recommender.mr.UgcLogCleaner /source/ugctail/Tail.log.$stat_date /result/ugctail/${stat_date}/"
