 ...
 * 用户行为数据清洗
 *
 * hadoop jar remd-hadoop-1.0-SNAPSHOT-jar-with-dependencies.jar com.xiaoxiaomo.hadoop.mr.RecommendJobTest /user/root/ugchead.log /recommender/result/20171022/
 *
